...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::Score1 => ColumnType::Decimal(Some((5u32, 2u32))).def().null(),
            Self::Score2 => ColumnType::Decimal(Some((5u32, 2u32))).def().null(),
            Self::Score3 => ColumnType::Decimal(Some((5u32, 2u32))).def().null(),
            Self::Score4 => ColumnType::Decimal(Some((5u32, 2u32))).def().null(),
            Self::Score5 => ColumnType::Decimal(Some((5u32, 2u32))).def().null(),
            Self::Score6 => ColumnType::Decimal(Some((5u32, 2u32))).def().null(),
